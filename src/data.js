...
import password from '../src/img/password.jpg';
...
export const products = [
    {
      ...
      description: "This is a Fitness Tracker application that allows users to join a like minded community to track and share workouts.",
    ...
    },
    {
      ...
      description: "This application is a Note Taker application. Allows the user to make notes for future reference. The user has the ability to save the notes for later and also delete the notes once they have completed them.",
      github: "https://github.com/Rbenney15/note-taker",
    },
    {
      id: 3,
      img: password,
      link: "https://rbenney15.github.io/password-generator/",
      description: "This is a random password generator to create more complex and secure passwords.",
    ...
    },
    {
      ...
      description: "Weather Dashboard application where a user can search for a city they would like to know the current and upcoming 5 day forecast.",
